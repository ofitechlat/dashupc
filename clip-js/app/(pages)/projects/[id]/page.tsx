...
import TranscriptionButton from "@/app/components/editor/AssetsPanel/SidebarButtons/TranscriptionButton";
...
import { TranscriptionPanel } from "../../../components/editor/AssetsPanel/TranscriptionPanel";
...
export default function Project({ params }: { params: { id: string } }) {
    ...
    const handleFocus = (section: "media" | "text" | "export" | "transcription") => {
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-[0.1] min-w-[60px] max-w-[100px] border-r border-gray-700 overflow-y-auto p-4">
                    <div className="flex flex-col space-y-2">
                        ...
                        <TranscriptionButton onClick={() => handleFocus("transcription")} />
