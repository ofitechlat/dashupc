...
export default function TranscriptionButton({ onClick }: { onClick: () => void }) {
    return (
        <button
        ...
        >
            <Image
                alt="Transcription Button"
                className="h-auto w-auto max-w-[30px] max-h-[30px]"
                height={30}
                width={30}
                src="https://www.svgrepo.com/show/532997/file-text.svg"
            />
            <span className="text-xs">Transcripción</span>
        </button>
    );
}
